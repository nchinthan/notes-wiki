...
def read_file(filename):
    ...
    try:
        ...
        print(filename,"has",e)
        return "SORRY PAGE IS MISSING"

def write_chunk(filename, chunk_content: bytes, chunk_index):
    """
    ...
    with open(f"{filename}.notes", "r+b") as f:
        f.seek(chunk_index * CHUNK_SIZE, os.SEEK_SET)
        f.write(chunk_content)  # ✅ Already bytes, no encoding
